...
singleton GuiControlProfile( ToolsRolloutProfile : ToolsDefaultProfile ) {
    ...
    hasBitmapArray = true;
    bitmap = "tlab/themes/DarkBlue/assets/container-assets/GuiRolloutProfile.png";
    textoffset = "24 1";
...
singleton GuiControlProfile( ToolsRolloutProfile : ToolsRolloutProfile ) {
    bitmap = "tlab/themes/DarkBlue/assets/container-assets/GuiRolloutProfile_S1.png";
    fontSize = "16";
   textOffset = "22 0";
};
//------------------------------------------------------------------------------
...
{
   bitmap = "tlab/themes/DarkBlue/assets/container-assets/GuiRolloutProfile_Alt.png";
...
singleton GuiControlProfile( ToolsRolloutTitle : ToolsRolloutProfile ) {
    ...
    hasBitmapArray = true;
    bitmap = "tlab/themes/DarkBlue/assets/container-assets/GuiRolloutTitle.png";
    textoffset = "22 0";
    fontType = "Aileron Bold";
    fontSize = "16";
    fontColors[0] = "253 253 253 255";
