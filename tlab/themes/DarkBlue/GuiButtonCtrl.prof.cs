...
singleton GuiControlProfile( ToolsButtonProfile : ToolsDefaultProfile ) {
	...
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiButtonProfile.png";
	hasBitmapArray = "1";
	fixedExtent = "0";
...
singleton GuiControlProfile( ToolsButtonDark : ToolsButtonProfile ) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiButtonDark.png";
	border = "-2";
...
singleton GuiControlProfile( ToolsButtonHighlight : ToolsButtonProfile ) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiButtonHighlight.png";
};
//------------------------------------------------------------------------------
...
singleton GuiControlProfile( ToolsCheckBoxProfile : ToolsDefaultProfile ) {
	...
	fixedExtent = 1;
	justify = "left";
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiCheckBoxProfile.png";
	hasBitmapArray = true;
	category = "Tools";
	fontType = "Gotham Book";
...
singleton GuiControlProfile( ToolsCheckBoxProfile : ToolsCheckBoxProfile ) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiCheckBoxProfile_S1.png";
	fontSize = "14";
};
//------------------------------------------------------------------------------
//ToolsCheckBoxProfile Large #1
singleton GuiControlProfile( ToolsCheckBoxProfile : ToolsCheckBoxProfile ) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiCheckBoxProfile_L1.png";
	fontSize = "22";
};
//------------------------------------------------------------------------------
...
singleton GuiControlProfile(ToolsRadioProfile : ToolsDefaultProfile) {
	...
	fontSize = "14";
	textOffset = "16 10";
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiRadioProfile_L1.png";
	hasBitmapArray = "1";
...
singleton GuiControlProfile( ToolsRadioProfile : ToolsRadioProfile ) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiRadioProfile_L1.png";
	fontSize = "14";
...
//------------------------------------------------------------------------------
singleton GuiControlProfile(ToolsRadioProfile : ToolsRadioProfile) {
	bitmap = "tlab/themes/DarkBlue/assets/button-assets/GuiRadioProfile_S1.png";
	fontSize = "12";
	justify = "Left";
	textOffset = "16 5";
	fontColors[8] = "255 0 255 255";
