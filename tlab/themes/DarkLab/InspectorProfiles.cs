...
singleton GuiControlProfile( GuiInspectorTextEditProfile : ToolsDefaultProfile ) {
    ...
    fontColors[0] = "254 254 254 255";
    fontColor = "254 254 254 255";
   bitmap = "tlab/themes/DarkLab/assets/element-assets/GuiTextEditProfile.png";
   hasBitmapArray = "1";
   modal = true;
   fontSize = "15";
