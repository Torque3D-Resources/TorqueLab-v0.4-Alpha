...
function DatablockEditorPlugin::cloneDatablock( %this,%deepCloning ) {
...
//==============================================================================
function DatablockEditorPlugin::createDatablockFinish( %this, %name, %copySource,%useSrcFile,%deepCloning,%autoSelect ) {
