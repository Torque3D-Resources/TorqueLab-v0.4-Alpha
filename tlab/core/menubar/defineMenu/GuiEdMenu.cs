...
function GuiEdMenu::initData(%this) {
	...
	$LabMenuItemGui_[%id,%itemId++] = "-";
	$LabMenuItemGui_[%id,%itemId++] = "Big Nudge Left" TAB "Shift Left" TAB "GuiEditor.move( - GuiEditor.snap2gridsize, 0 );";
	$LabMenuItemGui_[%id,%itemId++] = "Big Nudge Right" TAB "Shift Right" TAB "GuiEditor.move( GuiEditor.snap2gridsize, 0 );";
	$LabMenuItemGui_[%id,%itemId++] = "Big Nudge Up" TAB "Shift Up" TAB "GuiEditor.move( 0, - GuiEditor.snap2gridsize );";
	...
	$LabMenuItemGui_[%id,%itemId++] = "-> Lab Editors GUIs <-";
	$LabMenuItemGui_[%id,%itemId++] = "Remove from EditorGui" TAB "" TAB "Lab.setGuisToDefault();";
	$LabMenuItemGui_[%id,%itemId++] = "Add to EditorGui" TAB "" TAB "Lab.setGuisToEditor();";
