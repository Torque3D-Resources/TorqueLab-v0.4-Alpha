...
//------------------------------------------------------------------------------
//==============================================================================
$GLab::DefaultColorsFile = "tlab/EditorLab/editorDialogs/guiLab/colorPresets/default.cs";
...
function GLab::initColorPresetMenu( %this ) {
	...
	%filePathScript = "tlab/EditorLab/editorDialogs/guiLab/colorPresets/*.set.cs";
	%pid = 0;
