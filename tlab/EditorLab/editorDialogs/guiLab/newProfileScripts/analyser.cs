...
$ProfData_FieldSet["colorFontIds"] = "fontColors[0] fontColors[1] fontColors[2] fontColors[3] fontColors[4] fontColors[5] fontColors[6] fontColors[7] fontColors[8] fontColors[9]";
$ProfData_FieldSet["colorFont"] = "fontColor fontColorHL fontColorNA fontColorSEL fontColorLink fontColorLinkHL";
$ProfData_FieldSet["All"] = $ProfileFieldSet["colorFontIds"] SPC $ProfileFieldSet["colorFont"];
$ProfData_FieldsStore = "fontSize";
//==============================================================================
// Clear the Analyser saved globals
function GLab::clearProfilesGlobals(%this) {   
...
function GLab::postProfileScanReport(%this) {   
...
function GLab::scanAllToolProfileFile(%this,%postReport) {   
...
//==============================================================================
// Scan all profile files found in profile folder
function GLab::scanAllProfileFile(%this,%postReport) {   
    clearProfilesGlobals();
...
function GLab::scanProfileFile( %this,%file ) {        
...
function GLab::removeProfileFieldSet(%this, %profile,%set ) {
   %targetFields = $ProfileFieldSet[%set]; 
   if (%targetFields !$= "")
      removeProfileField(%profile,%targetFields);
}
   
function GLab::removeProfileField( %this, %profile,%targetFields ) {
