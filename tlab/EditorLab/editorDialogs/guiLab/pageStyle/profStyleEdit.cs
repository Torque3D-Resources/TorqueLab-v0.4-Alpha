...
function GLab::initProfileStyleParams(%this) {
	%gid = 0;
	%ar = createParamsArray("ProfileStyle",GLab_ProfileStyleStackParams,"$Lab");
	...
	//%ar.setVal("fontColors6",       "" TAB "fontColor (6)" TAB "ColorEdit" TAB "mode>>int" TAB "GLab.styleObj" TAB %gid);
	//%ar.setVal("fontColors7",       "" TAB "fontColor (7)" TAB "ColorEdit" TAB "mode>>int" TAB "GLab.styleObj" TAB %gid);
	//%ar.setVal("fontColors8",       "" TAB "fontColor (8)" TAB "ColorEdit" TAB "mode>>int" TAB "GLab.styleObj" TAB %gid);
	//%ar.setVal("fontColors9",       "" TAB "fontColor (9)" TAB "ColorEdit" TAB "mode>>int" TAB "GLab.styleObj" TAB %gid);
	/*
	 autoSizeHeight = "1";
	      autoSizeWidth = "1";
