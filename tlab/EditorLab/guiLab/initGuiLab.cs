...
function initGuiLab(%loadGui){
	...
	GlobalActionMap.bindCmd(keyboard, "f5", "toggleDlg(LabGuiManager);","");
	 exec("tlab/EditorLab/guiLab/prefs.cs");   
    newScriptObject("GLab");
 newScriptObject("LGTools");
   if (%loadGui)
      exec("tlab/EditorLab/guiLab/LabGuiManager.gui");
            
   exec("tlab/EditorLab/guiLab/LabGuiManager.cs");   

	execPattern("tlab/EditorLab/guiLab/pageProfile/*.cs");
	execPattern("tlab/EditorLab/guiLab/pageStyle/*.cs");
	execPattern("tlab/EditorLab/guiLab/pagePreset/*.cs");
	execPattern("tlab/EditorLab/guiLab/pageOption/*.cs");
	
   execPattern("tlab/EditorLab/guiLab/profileScripts/*.cs");   
    execPattern("tlab/EditorLab/guiLab/profileTools/*.cs");
