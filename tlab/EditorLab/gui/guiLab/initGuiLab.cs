...
function initGuiLab(%loadGui){
	...
	GlobalActionMap.bindCmd(keyboard, "f5", "toggleDlg(LabGuiManager);","");
	 exec("tlab/EditorLab/gui/guiLab/prefs.cs");   
    newScriptObject("GLab");
 newScriptObject("LGTools");
   if (%loadGui)
      exec("tlab/EditorLab/gui/guiLab/LabGuiManager.gui");
            
   exec("tlab/EditorLab/gui/guiLab/LabGuiManager.cs");   
	execPattern("tlab/EditorLab/gui/guiLab/profileManager/*.cs");
   execPattern("tlab/EditorLab/gui/guiLab/profileScripts/*.cs");
   execPattern("tlab/EditorLab/gui/guiLab/colorScripts/*.cs");
   execPattern("tlab/EditorLab/gui/guiLab/general/*.cs");
    execPattern("tlab/EditorLab/gui/guiLab/profileTools/*.cs");
