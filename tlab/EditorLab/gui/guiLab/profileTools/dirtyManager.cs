...
function LGTools::setProfileDirty( %this,%profile,%dirty ) {
...
//==============================================================================
// Set profile as dirty or remove from dirty list
function LGTools::setProfileNotDirty( %this,%profile ) {
  %name = %profile.getName();
...
//------------------------------------------------------------------------------
//==============================================================================
function LGTools::saveSelectedProfile( %this ) {   
   %id = GLab_ProfilesTree.getSelectedItem();
...
function LGTools::saveAllDirtyProfiles( %this) { 
...
//==============================================================================
// Load the Specific UI Style settings
function LGTools::saveProfile(%this,%profile,%forced,%noRescan ) {    
   ...
   LGTools.setProfileDirty(%profile,false);
