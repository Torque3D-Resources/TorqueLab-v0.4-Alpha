...
//LGTools.updateProfilesSetType("DefaultFontA","colorFont");
function LGTools::updateProfilesSetType(%this,%set,%type ) {   
...
//==============================================================================
// Update all the Color Sets assigned profiles
function LGTools::setProfileColorFromSet(%this,%set,%type ) {         
 	...
 	LGTools.updateProfileColorsSet(%profile,%set,%type);
 	switch$(%type){
 		case "colorFont":
