...
function ParamFileSelectBtn::onClick( %this ) {
	devLog("ParamFileSelectBtn::onClick",%this);
...
function paramFileSelectCallback( %file,%button,%textEdit ) {
	devLog("paramFileSelectCallback::%file",%file);	
	devLog("paramFileSelectCallback::%button %textEdit",%button,%textEdit,%textEdit.command);	
